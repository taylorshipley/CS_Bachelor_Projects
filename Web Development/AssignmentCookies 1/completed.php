        ...
        <header>
            ...
            <nav class="secondary_header" id="menu">
                <ul style= "align-content: center">
                    ...
                    <li><a style="text-decoration: none" href="NewAccount.php">CONTACT</a></li>
                </ul>
            </nav>
        </header>
        <body>
            ...
            if ($con->query($insert) == TRUE) {
                ...
                echo '<table style="width: 100%; text-align: left"><tr><th>Firstname</th><th>Lastname</th><th>Address</th><th>City</th><th>State</th><th>Zip</th><th>Phone</th></tr>';
