...
public class BinarySearchTree 
{
	...
	public void insert(int data, String userName)
	{
		BSTNode newNode = new BSTNode(data);  
		if(root == null)
		{  
	 ...
	 * @return the BST node
	 */
	public BSTNode searchUserName(BSTNode n, String data)
	{
			BSTNode result = null;
		    if (root == null)
		    {
		    ...
		    else
		    {
		        ...
		        {
		            if (current.userName.equals(data))
		            {
		            	result = current;
		                return result;
		            }
