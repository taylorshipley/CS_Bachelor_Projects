...
-- Get User ID Function test
SELECT 'This is function' AS "gosUser";
SELECT [dbo].udf_getUserID('ack.devin@gmail.com') AS 'EmailAddressID: ack.devin@gmail.com';
SELECT [dbo].udf_getUserID('refchrisadams@gmail.com') AS 'EmailAddressID: ack.devin@gmail.com';
SELECT [dbo].udf_getUserID('bga78@msn.com') AS 'EmailAddressID: ack.devin@gmail.com';
SELECT [dbo].udf_getUserID('grukmuk@msn.com') AS 'EmailAddressID: ack.devin@gmail.com';
SELECT [dbo].udf_getUserID('tybar14@hotmail.com') AS 'EmailAddressID: ack.devin@gmail.com';

--Get Question ID Function test
SELECT 'This is function' AS "gosSecurityQuestion";
SELECT [dbo].udf_getQuestionID('What was your childhood nickname?') AS 'SecurityQuestionID: What was your childhood nickname?';
SELECT [dbo].udf_getQuestionID('In what city did you meet your spouse/significant other?') AS 'SecurityQuestionID: In what city did you meet your spouse/significant other?';
SELECT [dbo].udf_getQuestionID('What is the name of your favorite childhood friend?') AS 'SecurityQuestionID: What is the name of your favorite childhood friend?';
SELECT [dbo].udf_getQuestionID('What street did you live on in third grade?') AS 'SecurityQuestionID: What street did you live on in third grade?';
SELECT [dbo].udf_getQuestionID('What is your oldest sibling''s birthday month and year? (e.g., January 1900)') AS 'SecurityQuestionID: What is your oldest sibling''s birthday month and year? (e.g., January 1900)';

--Get School ID Function test
SELECT 'This is function' AS "gosSchool";
SELECT [dbo].udf_getSchoolID('Bear River High School') AS 'SchoolID: Bear River High School';
SELECT [dbo].udf_getSchoolID('Bountiful High School') AS 'SchoolID: Bountiful High School';
SELECT [dbo].udf_getSchoolID('Box Elder High School') AS 'SchoolID: Box Elder High School';
SELECT [dbo].udf_getSchoolID('Clearfield High School') AS 'SchoolID: Clearfield High School';
SELECT [dbo].udf_getSchoolID('Davis High School') AS 'SchoolID: Davis High School';

--Get Sport Level ID Function test
SELECT 'This is function' AS "gosSportLevel";
SELECT [dbo].udf_getSportLevelID('Football', 'Varsity') AS 'SportLevelID: Varsity Football';
SELECT [dbo].udf_getSportLevelID('Football', 'Junior Varsity') AS 'SportLevelID: Junior Varsity Football';
SELECT [dbo].udf_getSportLevelID('Football', 'Sophomore') AS 'SportLevelID: Sophomore Football';
SELECT [dbo].udf_getSportLevelID('Football', 'Freshman') AS 'SportLevelID: Varsity Football';
SELECT [dbo].udf_getSportLevelID('Volleyball', 'Varsity') AS 'SportLevelID: Varsity Volleyball';

--Get Site ID Function test
SELECT 'This is function' AS "gosSite";
SELECT [dbo].udf_getSiteID('Bear River High School') AS 'SiteID: Bear River High School';
SELECT [dbo].udf_getSiteID('Clearfield High School') AS 'SiteID: Clearfield High School';
SELECT [dbo].udf_getSiteID('Dee Event Center') AS 'SiteID: Dee Event Center';
SELECT [dbo].udf_getSiteID('Farmington High School') AS 'SiteID: Farmington High School';
SELECT [dbo].udf_getSiteID('Fremont High School') AS 'SiteID: Fremont High School';

--Get Game ID Function test
SELECT 'This is function' AS "gosGameID";
SELECT [dbo].udf_getGameID('Northridge High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM') AS 'GameID: Northridge High School, Football, Varsity, Aug 26 2022 7:00 PM';
SELECT [dbo].udf_getGameID('Fremont High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM') AS 'GameID: Fremont High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM';
SELECT [dbo].udf_getGameID('Layton High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM') AS 'GameID: Layton High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM';
SELECT [dbo].udf_getGameID('Clearfield High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM') AS 'GameID: Clearfield High School', 'Football', 'Varsity', 'Aug 26 2022 7:00 PM';
SELECT [dbo].udf_getGameID('Morgan High School', 'Volleyball', 'Varsity', 'Aug 25 2022 6:30 PM') AS 'GameID: Morgan High School', 'Volleyball', 'Varsity', 'Aug 25 2022 6:30 PM';

--Get Position ID Function test
SELECT 'This is function' AS "gosGameID";
SELECT [dbo].udf_getPositionID('Referee') AS 'PositionID: Referee';
SELECT [dbo].udf_getPositionID('Umpire') AS 'PositionID: Umpire';
SELECT [dbo].udf_getPositionID('Head Linesman') AS 'PositionID: Head Linesman';
SELECT [dbo].udf_getPositionID('Line Judge') AS 'PositionID: Line Judge';
SELECT [dbo].udf_getPositionID('Back Judge') AS 'PositionID: Back Judge';